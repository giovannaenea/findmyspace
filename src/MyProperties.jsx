                  ...
                  <>
                    ...
                    <div className="myprops-card-actions">
                      <button className="myprops-action-btn myprops-edit-btn" onClick={() => startEdit(p)}>
                        <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" width="13" height="13">
                      ...
                      {confirmDeleteId === p.id ? (
                        <div className="myprops-delete-confirm">
                          <span style={{ fontSize: 12, color: 'var(--text-muted)' }}>
                            {p.status === 'approved' ? 'Take down listing?' : 'Delete listing?'}
                          </span>
